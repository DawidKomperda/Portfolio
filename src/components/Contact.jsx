...
const Contact = () => {
  ...
  return (
    ...
    md:flex ss:flex-row md:flex-col ss:items-end md:items-stretch ss:justify-center xs:grid ss:grid-cols-2 xs:gap-x-6
     `}>
      <div className={`flex flex-col justify-evenly md:flex-row md:w-full ${styles.boxWidth} ${styles.flexStart}`}>
        ...
        <div className={`${styles.mediaCard}`}>
          ...
          <div>
            ...
            <a href='tel:+00111222333' className={`${styles.mediaText}`}>+00 111 222 333</a>
          </div>
        </div>
      ...
      <div className={`${styles.flexStart}`}>
        <form ref={form} onSubmit={sendEmail}
          ...
          <textarea required name="message" placeholder='Message' className='resize overflow-auto text-black rounded-lg h-32 ss:h-[350px] sm:h-32 w-full col-span-2 ' />
